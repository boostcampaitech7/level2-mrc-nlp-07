...
class DataProcessor(ABC):
    @classmethod
    @abstractmethod
    def process(cls, datasets, data_args, tokenizer):
        pass


class DataPreProcessor(DataProcessor):
    @classmethod
    def process(cls, datasets: dict, data_args, tokenizer):
        """데이터 전처리
    ...
    def handle_features(cls, datasets: dict, type: str, tokenizer, data_args) -> dict:
...
class DataPostProcessor():
    def __init__(self, data_args, datasets) -> None:
        self.data_args = data_args
        self.datasets = datasets
        
        
    def process(self,examples, features, predictions, training_args):
        ...
        if training_args.do_predict:
            ...
            answer_column_name = ("answers" if "answers" in self.datasets.column_names else self.datasets.column_names[2])
            references = [
