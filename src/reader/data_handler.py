...
class DataHandler():
    def __init__(self, data_args: DataTrainingArguments, tokenizer: AutoTokenizer, proprocessor:DataProcessor, preprocessor:DataProcessor) -> None:
        """DataHandler 초기화 설정.
        Args:
        ...
        self.processors = {'pre':preprocessor.process, 'pro':proprocessor.process} 
    ...
    def process_func(self, type: str) -> dict:
        ...
        Returns:
            processed
        """
        processor_func = self.processors[type]
    ...
    def process_func(self, type: str) -> dict:
        ...
        """
        processed_data = self.processors[type]()
    ...
    def load_data(self, type: str) -> dict:
        ...
        datasets = self.process('pre')(self.datasets, type)
