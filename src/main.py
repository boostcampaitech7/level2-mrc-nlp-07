...
def reader():
    ...
    def preprocess(dataset):        
        ...
        return train_retriever_dataset
    ...
    reader_model = Reader(model_args, data_args, training_args, preprocess(train_retriever_dataset))
    reader_model.run()

    #추론
    predict_retriever_dataset = load_dataset('csv', data_files=SAVE_TEST_PATH)
    ...
    reader_model = Reader(model_args, data_args, training_args, preprocess(predict_retriever_dataset))
    reader_model.run()
