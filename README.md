...
#### Retriever 팀
* ㄴ Sparse 및 Dense 구현: 10.11(금) ~ 10.13(일)
* ㄴ Sparse 및 Dense 고도화: 10.14(월) ~ 10.16(수)
* ㄴ Re-ranking 실험 및 하이퍼파라미터 튜닝: 10.17(목) ~ 10.23(수)

#### Reader 팀
* ㄴ Reader 구조 설정 : 10.11(금) ~ 10.13(일)
* ㄴ Reader 재구성 및 베이스라인 수립: 10.14(월) ~ 10.16(수)
...
이를 바탕으로 전체 프로젝트는 Retriever과 Reader로 구분하여 팀을 구성하였고, 각 팀은 독립적으로 최적화된 결과를 내는 것을 목표로 실험과 개발을 진행하였습니다.
